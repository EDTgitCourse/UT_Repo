...
Функция ТекстРекомендацииДляРегистратораРасчетов() Экспорт
	...
	Возврат НСтр("ru = 'Для аналитики учета по партнерам и объекта расчетов документа необходимо проверить правильность остатков и оборотов
	|в отчете ""Ведомость расчетов с клиентами"" или ""Ведомость расчетов с поставщиками"".'");
...
Функция ТекстНепредвиденнаяСитуацияПриОбновленииДокумента() Экспорт
	...
	Возврат НСтр("ru = 'При обновлении движений документа произошла исключительная ситуация (см. журнал регистрации). Обновление документа отменено.'");
...
Процедура ЗаписатьНаборыРегистраторов(НаборЗаписей, НаборыРегистраторовРасчетов)
	...
	Для Каждого Описание Из НаборыРегистраторовРасчетов Цикл
		...
		Если Набор.Количество() > 0 Тогда
			ИзменилисьИтоги = ЕстьИзмененияИтоговНабора(Набор, Описание.Значение.КэшНабора);
		КонецЕсли;
