// Регистрация Правила регистрации для конфигурации ERP 2.5.17 от 04.03.2025 15:05:34
...
Функция ПараметрыРегистрации() Экспорт
	...
	Наименование =  НСтр("ru = 'Правила регистрации для конфигурации ERP 2.5.17'");
	Результат.Вставить("Наименование", Наименование);
	Результат.Вставить("ДатаВремяСоздания", Дата(2024,10,23,12,15,0));
