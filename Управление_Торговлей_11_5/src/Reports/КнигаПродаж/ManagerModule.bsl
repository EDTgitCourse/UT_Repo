	...
	Иначе
		...
		Если СтруктураПараметров.ЗаполнениеДекларации
		   И СтруктураПараметров.ПравилаЗаполнения = "2025Кв1" Тогда
			...
			ИтогиРаздел9.Вставить("ИтСтПродКПр7");
			ИтогиРаздел9.Вставить("ИтСтПродКПр5");
			ИтогиРаздел9.Вставить("СумНДСИтКПр7");
			ИтогиРаздел9.Вставить("СумНДСИтКПр5");
			ИтогиРаздел9.Вставить("СтПродВсП1Р9_7");
			ИтогиРаздел9.Вставить("СтПродВсП1Р9_5");
			ИтогиРаздел9.Вставить("СумНДСВсП1Р9_7");
			ИтогиРаздел9.Вставить("СумНДСВсП1Р9_5");
		КонецЕсли;
